...
export default function NewsPage() {
  const news = [
    ...
    { title: "mu-ga-lim.kz енді Наурыз мейрамын автоматты түрде есептейді", date: "05.04.2026", desc: "Біз Smart Calendar-ды жаңарттық. Енді КТЖ генерациялау кезінде барлық көктемгі мерекелер ескеріледі." },
